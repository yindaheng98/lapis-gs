...
from lapisgs.prepare import modes
from lapisgs.train import prepare_training
...
if __name__ == "__main__":
    ...
    for resolution in args.resolution_scales:
        ...
        dataset, gaussians, trainer = prepare_training(
            ...
            load_ply=foundation_gs_path, load_camera=args.load_camera, load_depth=not args.no_depth_data, rescale_factor=1/resolution, with_scale_reg=args.with_scale_reg, configs=configs)
